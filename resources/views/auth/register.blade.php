    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="flex items-center justify-between mt-4">
            ...
            <div class="flex space-x-4">
                ...
                <x-primary-button type="button" onclick="setRoleAndSubmit('customer')">
                    {{ __('Register as Customer') }}
                </x-primary-button>

                <!-- Register as Admin -->
                <x-primary-button type="button" onclick="setRoleAndSubmit('admin')" class="bg-gray-800 hover:bg-gray-700">
